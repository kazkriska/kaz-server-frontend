      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/40 backdrop-blur-md">
          <div className="bg-[#2f334d]/80 backdrop-blur-lg border border-white/10 p-8 rounded-xl shadow-2xl max-w-sm w-full text-center relative flex flex-col items-center gap-6">
            ...
            <h2 className="text-2xl font-bold tracking-widest uppercase text-[#86e1fc]">Get in touch</h2>
            
            <div className="flex justify-center gap-6 text-[#c8d3f5]">
              {/* GitHub */}
              <a href="https://github.com/kazkriska" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/kashish-kumar99" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
